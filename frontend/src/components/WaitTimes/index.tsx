...
const WaitTimes = () => {
  return (<>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div className="bg-gradient-to-r from-pink-500 to-red-500 p-6 rounded-lg shadow-lg text-white ">
      ...
      {/* Emergency Visits */}
      <div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-6 rounded-lg shadow-lg text-white ">
